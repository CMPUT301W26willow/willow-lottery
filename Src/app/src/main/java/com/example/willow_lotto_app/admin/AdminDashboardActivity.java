...
public class AdminDashboardActivity extends AppCompatActivity {
    ...
    /**
     * fetches notifications across users via and shows them through an alert
     */

    private void showNotificationLogDialog() {
        FirebaseFirestore.getInstance()
                .collectionGroup("notifications") //look in the notifications collections
                .get()
                .addOnSuccessListener(snapshots -> {
                    ...
                    for (QueryDocumentSnapshot doc : snapshots) {
                        // read the title, message and type of each notification
